        ...
        <div className={`${cardCls} overflow-hidden animate-scale-in border-l-4 ${
            ...
            {expanded && (
                <div className="px-4 pb-4 space-y-3 animate-fade-in">
                    ...
                    {/* Disclaimer */}
                    <div className="flex items-center gap-1.5 px-3 py-2 bg-amber-500/10 border border-amber-500/20 rounded-lg mt-2">
                        <AlertTriangle className="w-3.5 h-3.5 text-amber-500" />
                        <span className="text-[11px] text-amber-500/90 font-medium">
                            AI reviews transcripts only and may miss visual explicit content.
                        </span>
                    </div>
