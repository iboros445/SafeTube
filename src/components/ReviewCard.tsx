        ...
        <div className={`${cardCls} overflow-hidden animate-scale-in border-l-4 ${
            ...
            {expanded && (
                <div className="px-4 pb-4 space-y-3 animate-fade-in">
                    ...
                    {/* Disclaimer */}
                    <div className="flex items-start gap-2.5 p-3 rounded-xl bg-orange-500/10 border border-orange-500/20 mt-2">
                        <AlertTriangle className="w-4 h-4 text-orange-400 flex-shrink-0 mt-0.5" />
                        <p className="text-xs text-orange-400/90 leading-relaxed">
                            <strong>AI Disclaimer:</strong> This score is automatically generated by an AI model evaluating the video's transcript. It does not "see" the video and may occasionally miss visual explicit content or misinterpret context. Please use your best judgment.
                        </p>
                    </div>
